...
def main():
    employees = list()
    employees.append(SalaryEmployee("Clay", [1, 3, 4], 23.14))
    employees.append(SalaryEmployee("Karen", [1, 3, 4], 15.43))
    employees.append(Employee("Mary", [1, 3, 4], 9))
...
##    employees.append(Employee("Helper2", [6], 12))
##    employees.append(Employee("Helper", [6], 12))
    employees.append(BookEmployee("Ronnie", [7], 18.5, eff_rate=0.4))
##    employees.append(BookEmployee("Ronnie2", [7], 18.5, eff_rate=0.4))
    employees.append(Employee("Detail", [9, 10], 12))
##    employees.append(Employee("Detail2", [9, 10], 12))
