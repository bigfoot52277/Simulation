...
class Employee(object):
    ...
    def finishPhoneCall(self):
        self.finishJob()
        if self.manager.totalPhoneCalls % 7 == 0:
    ...
    def finishBodyWork(self):
        ...
        if self.manager.totalRepairOrders % 4:
            ...
            t.start()
            self.manager.timers.append(t)
        elif self.manager.totalRepairOrders % self.error_rate == 0:
    ...
    def work(self, job_type):
        if job_type == 1: # phone call
            ...
            if self.manager.debug:
                print('{} Answering the phone'.format(self.name))
            ...
            import estimate
            if self.manager.debug:
                print('{} Writing an Estimate'.format(self.name))
            job_time = estimate.write_estimate()/self.manager.dtime
            self.startJob()
            ...
            import delivery
            if self.manager.debug:
                print('{} Delivering a vehicle'.format(self.name))
            ...
            import bodywork
            if self.manager.debug:
                print('{} Working the body'.format(self.name))
            ...
            import assemble
            if self.manager.debug:
                print('{} Putting back together'.format(self.name))
